...
const double AnalysisHandlerATLAS_8TeV::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerATLAS_8TeV::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerATLAS_8TeV::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerATLAS_8TeV::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerATLAS_8TeV::PTMIN_TAU_TRUTH = 10.0;

const double AnalysisHandlerATLAS_8TeV::DR_B_TRUTH = 0.4;
const double AnalysisHandlerATLAS_8TeV::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerATLAS_8TeV::PTMIN_B_TRUTH = 1.0;

AnalysisHandlerATLAS_8TeV::AnalysisHandlerATLAS_8TeV() : AnalysisHandler() {
}

AnalysisHandlerATLAS_8TeV::~AnalysisHandlerATLAS_8TeV() {
}

void AnalysisHandlerATLAS_8TeV::initialize() {
}

void AnalysisHandlerATLAS_8TeV::finalize() {
}

void AnalysisHandlerATLAS_8TeV::bookAnalysis(std::string analysisName,
                                        Tag_Map whichTags,
                                        Param_Map eventParameters) {
    Global::print(name, "Loading Analysis "+analysisName);

    AnalysisBase* a = NULL;
    if(analysisName == "atlas_1308_1841")
        a = new Atlas_1308_1841();
    else if(analysisName == "atlas_1308_2631")
        a = new Atlas_1308_2631();
    else if(analysisName == "atlas_1402_7029")
        a = new Atlas_1402_7029();
    else if(analysisName == "atlas_1403_4853")
        a = new Atlas_1403_4853();
    else if(analysisName == "atlas_1403_5222")
        a = new Atlas_1403_5222();
    else if(analysisName == "atlas_1403_5294")
        a = new Atlas_1403_5294();
    else if(analysisName == "atlas_1403_5294_CR")
        a = new Atlas_1403_5294_CR();
    else if(analysisName == "atlas_1404_2500")
        a = new Atlas_1404_2500();
    else if(analysisName == "atlas_1405_7875")
        a = new Atlas_1405_7875();
    else if(analysisName == "atlas_1407_0583")
        a = new Atlas_1407_0583();
    else if(analysisName == "atlas_1407_0600")
        a = new Atlas_1407_0600();
    else if(analysisName == "atlas_1407_0608")
        a = new Atlas_1407_0608();
    else if(analysisName == "atlas_1411_1559")
        a = new Atlas_1411_1559();
    else if(analysisName == "atlas_1501_07110")
        a = new Atlas_1501_07110();
    else if(analysisName == "atlas_1502_01518")
        a = new Atlas_1502_01518();
    else if(analysisName == "atlas_1503_03290")
        a = new Atlas_1503_03290();
    else if(analysisName == "atlas_1506_08616")
        a = new Atlas_1506_08616();
    else if(analysisName == "atlas_conf_2012_104")
        a = new Atlas_conf_2012_104();
    else if(analysisName == "atlas_conf_2012_104_CR")
        a = new Atlas_conf_2012_104_CR();
    else if(analysisName == "atlas_conf_2012_147")
        a = new Atlas_conf_2012_147();
    else if(analysisName == "atlas_conf_2012_147_CR")
        a = new Atlas_conf_2012_147_CR();
    else if(analysisName == "atlas_conf_2013_021")
        a = new Atlas_conf_2013_021();
    else if(analysisName == "atlas_conf_2013_024")
        a = new Atlas_conf_2013_024();
    else if(analysisName == "atlas_conf_2013_024_CR")
        a = new Atlas_conf_2013_024_CR();
    else if(analysisName == "atlas_conf_2013_031")
        a = new Atlas_conf_2013_031();
    else if(analysisName == "atlas_conf_2013_035")
        a = new Atlas_conf_2013_035();
    else if(analysisName == "atlas_conf_2013_036")
        a = new Atlas_conf_2013_036();
    else if(analysisName == "atlas_conf_2013_037")
        a = new Atlas_conf_2013_037();
    else if(analysisName == "atlas_conf_2013_047")
        a = new Atlas_conf_2013_047();
    else if(analysisName == "atlas_conf_2013_047_CR")
        a = new Atlas_conf_2013_047_CR();
    else if(analysisName == "atlas_conf_2013_048")
        a = new Atlas_conf_2013_048();
    else if(analysisName == "atlas_conf_2013_049")
        a = new Atlas_conf_2013_049();
    else if(analysisName == "atlas_conf_2013_049_CR")
        a = new Atlas_conf_2013_049_CR();
    else if(analysisName == "atlas_conf_2013_061")
        a = new Atlas_conf_2013_061();
    else if(analysisName == "atlas_conf_2013_061_CR")
        a = new Atlas_conf_2013_061_CR();
    else if(analysisName == "atlas_conf_2013_062")
        a = new Atlas_conf_2013_062();
    else if(analysisName == "atlas_conf_2013_089")
        a = new Atlas_conf_2013_089();
    else if(analysisName == "atlas_conf_2013_089_CR")
        a = new Atlas_conf_2013_089_CR();
    else if(analysisName == "atlas_conf_2014_014")
        a = new Atlas_conf_2014_014();
    else if(analysisName == "atlas_conf_2014_033")
        a = new Atlas_conf_2014_033();
    else if(analysisName == "atlas_conf_2014_056")
...
void AnalysisHandlerATLAS_8TeV::postProcessParticles() {
...
void AnalysisHandlerATLAS_8TeV::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerATLAS_8TeV::identifyElectrons() {
...
void AnalysisHandlerATLAS_8TeV::identifyMuons()  {
...
void AnalysisHandlerATLAS_8TeV::tagBJets() {
   ...
   for(int j = 0; j < jets.size(); j++) {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerATLAS_8TeV::bSigEff;
                  break;
              }
          }
          ...
          if (eff_function == NULL) {
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     fabs(true_c[c]->Eta) < PTMIN_B_TRUTH &&
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerATLAS_8TeV::bBkgCJetEff;
                      break;
                  }
              }
          }
          ...
          if (eff_function == NULL)
              eff_function = &AnalysisHandlerATLAS_8TeV::bBkgLJetEff;
...
void AnalysisHandlerATLAS_8TeV::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerATLAS_8TeV::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerATLAS_8TeV::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerATLAS_8TeV::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerATLAS_8TeV::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerATLAS_8TeV::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerATLAS_8TeV::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerATLAS_8TeV::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerATLAS_8TeV::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerATLAS_8TeV::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerATLAS_8TeV::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerATLAS_8TeV::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerATLAS_8TeV::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerATLAS_8TeV::linkObjects() {
...
double AnalysisHandlerATLAS_8TeV::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerATLAS_8TeV::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerATLAS_8TeV::electronIDEffMedium(double pt,
                                               double eta) {
...
double AnalysisHandlerATLAS_8TeV::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerATLAS_8TeV::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerATLAS_8TeV::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerATLAS_8TeV::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_8TeV::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_8TeV::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_8TeV::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_8TeV::bSigEff(double pt,
                                     double eta,
                                     double eff) {
...
double AnalysisHandlerATLAS_8TeV::bBkgCJetRej(double eff) {
...
double AnalysisHandlerATLAS_8TeV::bBkgCJetEff(double pt,
                                         double eta,
                                         double eff) {
...
double AnalysisHandlerATLAS_8TeV::bBkgLJetRej(double eff) {
...
double AnalysisHandlerATLAS_8TeV::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
...
const AnalysisHandlerATLAS_8TeV::muonDetector AnalysisHandlerATLAS_8TeV::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
        ...
        {cscsm, endsm, endsm, endsm, endsm, endsm, endsm, trans, barla, barla, barla, barla, barla, trans, endsm, endsm, endsm, endsm, endsm, endsm, cscsm},
        {cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla}};
const double AnalysisHandlerATLAS_8TeV::etaProj[21] = {-2.005, -1.955, -1.709, -1.411, -1.238, -1.163, -1.113, -0.965, -0.817, -0.519, 0.519, 0.817, 0.965, 1.113, 1.163, 1.238, 1.411, 1.709, 1.955, 2.005, 2.500};
const double AnalysisHandlerATLAS_8TeV::phiProj[53] = {3.142, 3.009, 2.948, 2.849, 2.629, 2.529, 2.471, 2.210, 2.174, 2.065, 1.855, 1.745, 1.695, 1.436, 1.386, 1.276, 1.066, 0.957, 0.916, 0.657, 0.596, 0.496, 0.277, 0.178, 0.142, -0.142, -0.178, -0.277, -0.496, -0.596, -0.657, -0.916, -0.957, -1.018, -1.066, -1.276, -1.357, -1.386, -1.436, -1.695, -1.745, -1.797, -1.855, -2.065, -2.134, -2.174, -2.210, -2.471, -2.529, -2.629, -2.849, -2.948, -3.009};
