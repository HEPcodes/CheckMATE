...
const double AnalysisHandlerATLAS::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerATLAS::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerATLAS::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerATLAS::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerATLAS::PTMIN_TAU_TRUTH = 10.0;

const double AnalysisHandlerATLAS::DR_B_TRUTH = 0.4;
const double AnalysisHandlerATLAS::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerATLAS::PTMIN_B_TRUTH = 1.0;

AnalysisHandlerATLAS::AnalysisHandlerATLAS() : AnalysisHandler() {
}

AnalysisHandlerATLAS::~AnalysisHandlerATLAS() {
}

void AnalysisHandlerATLAS::initialize() {
}

void AnalysisHandlerATLAS::finalize() {
}

void AnalysisHandlerATLAS::bookAnalysis(std::string analysisName,
                                        Tag_Map whichTags,
...
void AnalysisHandlerATLAS::postProcessParticles() {
...
void AnalysisHandlerATLAS::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerATLAS::identifyElectrons() {
...
void AnalysisHandlerATLAS::identifyMuons()  {
...
void AnalysisHandlerATLAS::tagBJets() {
   ...
   for(int j = 0; j < jets.size(); j++) {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerATLAS::bSigEff;
                  break;
              }
          }
              ...
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     ...
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerATLAS::bBkgCJetEff;
                      break;
                  }
              }
          }
          ...
          if (eff_function == NULL)
              eff_function = &AnalysisHandlerATLAS::bBkgLJetEff;
...
void AnalysisHandlerATLAS::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerATLAS::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerATLAS::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerATLAS::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerATLAS::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerATLAS::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerATLAS::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerATLAS::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerATLAS::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerATLAS::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerATLAS::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerATLAS::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerATLAS::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerATLAS::linkObjects() {
...
double AnalysisHandlerATLAS::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerATLAS::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerATLAS::electronIDEffMedium(double pt,
                                               double eta) {
...
double AnalysisHandlerATLAS::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerATLAS::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerATLAS::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerATLAS::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS::bSigEff(double pt,
                                     double eta,
                                     double eff) {
...
double AnalysisHandlerATLAS::bBkgCJetRej(double eff) {
...
double AnalysisHandlerATLAS::bBkgCJetEff(double pt,
                                         double eta,
                                         double eff) {
...
double AnalysisHandlerATLAS::bBkgLJetRej(double eff) {
...
double AnalysisHandlerATLAS::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
...
const AnalysisHandlerATLAS::muonDetector AnalysisHandlerATLAS::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
        ...
        {cscsm, endsm, endsm, endsm, endsm, endsm, endsm, trans, barla, barla, barla, barla, barla, trans, endsm, endsm, endsm, endsm, endsm, endsm, cscsm},
        {cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla}};
const double AnalysisHandlerATLAS::etaProj[21] = {-2.005, -1.955, -1.709, -1.411, -1.238, -1.163, -1.113, -0.965, -0.817, -0.519, 0.519, 0.817, 0.965, 1.113, 1.163, 1.238, 1.411, 1.709, 1.955, 2.005, 2.500};
const double AnalysisHandlerATLAS::phiProj[53] = {3.142, 3.009, 2.948, 2.849, 2.629, 2.529, 2.471, 2.210, 2.174, 2.065, 1.855, 1.745, 1.695, 1.436, 1.386, 1.276, 1.066, 0.957, 0.916, 0.657, 0.596, 0.496, 0.277, 0.178, 0.142, -0.142, -0.178, -0.277, -0.496, -0.596, -0.657, -0.916, -0.957, -1.018, -1.066, -1.276, -1.357, -1.386, -1.436, -1.695, -1.745, -1.797, -1.855, -2.065, -2.134, -2.174, -2.210, -2.471, -2.529, -2.629, -2.849, -2.948, -3.009};
