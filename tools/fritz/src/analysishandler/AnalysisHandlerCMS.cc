...
const double AnalysisHandlerCMS::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerCMS::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerCMS::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerCMS::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerCMS::PTMIN_TAU_TRUTH = 1.0;

const double AnalysisHandlerCMS::DR_B_TRUTH = 0.4;
const double AnalysisHandlerCMS::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerCMS::PTMIN_B_TRUTH = 1.0;


AnalysisHandlerCMS::AnalysisHandlerCMS() : AnalysisHandler() {
}

AnalysisHandlerCMS::~AnalysisHandlerCMS() {
}

void AnalysisHandlerCMS::initialize() {
}

void AnalysisHandlerCMS::finalize() {
}

void AnalysisHandlerCMS::bookAnalysis(std::string analysisName,
                                      Tag_Map whichTags,
...
void AnalysisHandlerCMS::postProcessParticles() {
...
void AnalysisHandlerCMS::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerCMS::identifyElectrons() {
...
void AnalysisHandlerCMS::identifyMuons()  {
...
void AnalysisHandlerCMS::tagBJets() {
   ...
   for(int j = 0; j < jets.size(); j++) {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerCMS::bSigEff;
                  break;
              }
          }
              ...
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     ...
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerCMS::bBkgCJetEff;
                      break;
                  }
              }
          }
          ...
          if (eff_function == NULL)
              eff_function = &AnalysisHandlerCMS::bBkgLJetEff;
...
void AnalysisHandlerCMS::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerCMS::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerCMS::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerCMS::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerCMS::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerCMS::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerCMS::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerCMS::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerCMS::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerCMS::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerCMS::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerCMS::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerCMS::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerCMS::linkObjects() {
...
double AnalysisHandlerCMS::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerCMS::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerCMS::electronIDEffMedium(double pt,
                                               double eta) {
...
double AnalysisHandlerCMS::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerCMS::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerCMS::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerCMS::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerCMS::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerCMS::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerCMS::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerCMS::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerCMS::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerCMS::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerCMS::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
double AnalysisHandlerCMS::bSigEff(double pt,
                                     double eta,
                                     double eff) {
...
double AnalysisHandlerCMS::bBkgCJetRej(double eff) {
...
double AnalysisHandlerCMS::bBkgCJetEff(double pt,
                                         double eta,
                                         double eff) {
...
double AnalysisHandlerCMS::bBkgLJetRej(double eff) {
...
double AnalysisHandlerCMS::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
...
const AnalysisHandlerCMS::muonDetector AnalysisHandlerCMS::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
        ...
        {cscsm, endsm, endsm, endsm, endsm, endsm, endsm, trans, barla, barla, barla, barla, barla, trans, endsm, endsm, endsm, endsm, endsm, endsm, cscsm},
        {cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla}};
const double AnalysisHandlerCMS::etaProj[21] = {-2.005, -1.955, -1.709, -1.411, -1.238, -1.163, -1.113, -0.965, -0.817, -0.519, 0.519, 0.817, 0.965, 1.113, 1.163, 1.238, 1.411, 1.709, 1.955, 2.005, 2.500};
const double AnalysisHandlerCMS::phiProj[53] = {3.142, 3.009, 2.948, 2.849, 2.629, 2.529, 2.471, 2.210, 2.174, 2.065, 1.855, 1.745, 1.695, 1.436, 1.386, 1.276, 1.066, 0.957, 0.916, 0.657, 0.596, 0.496, 0.277, 0.178, 0.142, -0.142, -0.178, -0.277, -0.496, -0.596, -0.657, -0.916, -0.957, -1.018, -1.066, -1.276, -1.357, -1.386, -1.436, -1.695, -1.745, -1.797, -1.855, -2.065, -2.134, -2.174, -2.210, -2.471, -2.529, -2.629, -2.849, -2.948, -3.009};
