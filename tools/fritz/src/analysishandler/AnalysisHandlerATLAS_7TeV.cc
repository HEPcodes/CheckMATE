...
const double AnalysisHandlerATLAS_7TeV::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerATLAS_7TeV::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerATLAS_7TeV::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerATLAS_7TeV::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerATLAS_7TeV::PTMIN_TAU_TRUTH = 10.0;

const double AnalysisHandlerATLAS_7TeV::DR_B_TRUTH = 0.4;
const double AnalysisHandlerATLAS_7TeV::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerATLAS_7TeV::PTMIN_B_TRUTH = 1.0;

AnalysisHandlerATLAS_7TeV::AnalysisHandlerATLAS_7TeV() : AnalysisHandler() {
}

AnalysisHandlerATLAS_7TeV::~AnalysisHandlerATLAS_7TeV() {
}

void AnalysisHandlerATLAS_7TeV::initialize() {
}

void AnalysisHandlerATLAS_7TeV::finalize() {
}
...
void AnalysisHandlerATLAS_7TeV::bookAnalysis(std::string analysisName,
    ...
    AnalysisBase* a = NULL;
    if(analysisName == "atlas_1210_2979")
        a = new Atlas_1210_2979();
    else //@@extracode@@
        Global::abort(name,
...
void AnalysisHandlerATLAS_7TeV::postProcessParticles() {
...
void AnalysisHandlerATLAS_7TeV::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerATLAS_7TeV::identifyElectrons() {
...
void AnalysisHandlerATLAS_7TeV::identifyMuons()  {
...
void AnalysisHandlerATLAS_7TeV::tagBJets() {
   ...
   for(int j = 0; j < jets.size(); j++) {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerATLAS_7TeV::bSigEff;
                  break;
              }
          }
              ...
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     ...
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerATLAS_7TeV::bBkgCJetEff;
                      break;
                  }
              }
          }
          ...
          if (eff_function == NULL)
              eff_function = &AnalysisHandlerATLAS_7TeV::bBkgLJetEff;
...
void AnalysisHandlerATLAS_7TeV::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerATLAS_7TeV::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerATLAS_7TeV::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerATLAS_7TeV::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerATLAS_7TeV::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerATLAS_7TeV::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerATLAS_7TeV::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerATLAS_7TeV::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerATLAS_7TeV::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerATLAS_7TeV::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerATLAS_7TeV::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerATLAS_7TeV::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerATLAS_7TeV::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerATLAS_7TeV::linkObjects() {
...
double AnalysisHandlerATLAS_7TeV::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerATLAS_7TeV::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerATLAS_7TeV::electronIDEffMedium(double pt,
                                               double eta) {
...
double AnalysisHandlerATLAS_7TeV::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerATLAS_7TeV::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerATLAS_7TeV::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerATLAS_7TeV::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_7TeV::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_7TeV::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_7TeV::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_7TeV::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_7TeV::bSigEff(double pt,
                                     double eta,
                                     double eff) {
...
double AnalysisHandlerATLAS_7TeV::bBkgCJetRej(double eff) {
...
double AnalysisHandlerATLAS_7TeV::bBkgCJetEff(double pt,
                                         double eta,
                                         double eff) {
...
double AnalysisHandlerATLAS_7TeV::bBkgLJetRej(double eff) {
...
double AnalysisHandlerATLAS_7TeV::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
...
const AnalysisHandlerATLAS_7TeV::muonDetector AnalysisHandlerATLAS_7TeV::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
        ...
        {cscsm, endsm, endsm, endsm, endsm, endsm, endsm, trans, barla, barla, barla, barla, barla, trans, endsm, endsm, endsm, endsm, endsm, endsm, cscsm},
        {cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla}};
const double AnalysisHandlerATLAS_7TeV::etaProj[21] = {-2.005, -1.955, -1.709, -1.411, -1.238, -1.163, -1.113, -0.965, -0.817, -0.519, 0.519, 0.817, 0.965, 1.113, 1.163, 1.238, 1.411, 1.709, 1.955, 2.005, 2.500};
const double AnalysisHandlerATLAS_7TeV::phiProj[53] = {3.142, 3.009, 2.948, 2.849, 2.629, 2.529, 2.471, 2.210, 2.174, 2.065, 1.855, 1.745, 1.695, 1.436, 1.386, 1.276, 1.066, 0.957, 0.916, 0.657, 0.596, 0.496, 0.277, 0.178, 0.142, -0.142, -0.178, -0.277, -0.496, -0.596, -0.657, -0.916, -0.957, -1.018, -1.066, -1.276, -1.357, -1.386, -1.436, -1.695, -1.745, -1.797, -1.855, -2.065, -2.134, -2.174, -2.210, -2.471, -2.529, -2.629, -2.849, -2.948, -3.009};
